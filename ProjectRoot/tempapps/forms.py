...
class QuestionForm(forms.Form):
    ...
    '''
        추가적인 속성을 부여할떄는 위젯에 attrs을 기술한다.
    '''
    ...
    '''(멀티선택)
    select 태그를 표현하는 것은 5번과 동일하지만 multiple속성을 부여하여
    2개 이상의 항목을 선택할 수 있게 한다.
    또한 default값을 표현하기 위해 2개이상의 항목을 선택할 수 있어야
    하므로 리스트를 사용해야 한다.
    '''
    ...
    '''
    체크박스를 표현한다. (멀티 선택)
    추가적인 속성을 부여할땐 attrs={'class': 'red'} 와 같이 기술한다.
    '''
